...
import playersData from "/all_players.json"; // ✅ Import player dataset
...
export default function StatsPage() {
  ...
  const seasonOptions = Array.from({ length: 25 }, (_, i) => {
    const year = (2000 + i).toString();
    return {
      value: year,
      label: `${year - 1}-${year.slice(-2)} Regular Season`,
    };
  }).reverse();
